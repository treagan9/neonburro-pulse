...
import { TbUser, TbMail, TbCheck, TbAlertTriangle, TbAt, TbPhone } from 'react-icons/tb';
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        w="200px"
        h="200px"
        bg="radial-gradient(circle at top right, rgba(0,229,229,0.06), transparent 60%)"
        pointerEvents="none"
      />
