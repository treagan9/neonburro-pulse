...
// Top of dashboard: pulsing dot + team avatars (no count), time, refresh
...
const SystemHeader = ({ onRefresh, refreshing }) => {
  ...
  return (
    <HStack justify="space-between" align="center" flexWrap="wrap" spacing={4}>
      ...
      <HStack spacing={3}>
        <Box textAlign="right">
          <Text color="white" fontSize="sm" fontWeight="700" fontFamily="mono" lineHeight="1" letterSpacing="0.02em">
            {formattedTime}
          </Text>
        ...
        <Tooltip label="Refresh" placement="bottom" hasArrow bg="surface.800" color="white" fontSize="xs">
          <IconButton
            ...
            _hover={{ color: 'brand.500', borderColor: 'brand.500', bg: 'rgba(0,229,229,0.05)' }}
